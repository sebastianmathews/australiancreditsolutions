  ...
  return (
    <section className="py-10 sm:py-16 px-4 sm:px-6 bg-white">
      <div className="max-w-4xl mx-auto">
        <h2 className="font-display text-lg sm:text-xl md:text-[32px] font-bold text-gray-900 mb-4 sm:mb-6 text-center leading-tight">
        ...
        <div className="text-xs sm:text-sm md:text-base text-gray-600 leading-relaxed">
          ...
          <div className="bg-gradient-to-br from-emerald-50/80 to-emerald-300/50 border-l-4 border-emerald-600 px-4 sm:px-6 py-4 sm:py-5 rounded-r-xl my-4 sm:my-6">
        ...
        <div className="text-center mt-6 sm:mt-8">
          <Link href="/services" className="text-emerald-600 font-semibold hover:underline text-base sm:text-lg inline-flex items-center gap-1">
            Explore Our Credit Repair Services <FaArrowRight />
          </Link>
        </div>
      </div>
    </section>
